...
1. Download the Windows portable build from the [GitHub Releases](https://github.com/max-well-house/AIDesktopSearch/releases) page (`Meshen-1.0.2-windows-portable.exe`, or the current version).
