...
A **local-first desktop app** (**Meshen**) that turns the files on your computer into a searchable knowledge base. You ask in plain language; it finds the right documents by meaning and keyword, and surfaces answers with clear pointers back to the source files. Nothing leaves your machine unless you choose otherwise.
